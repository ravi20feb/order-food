...
export function RestaurantMenu(){
    ...
    useEffect(()=>{
      ...
      async  function getMenuList(){
        const url = 'https://corsproxy.io/?' + encodeURIComponent(`https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=${lat}&lng=${lng}&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`);
