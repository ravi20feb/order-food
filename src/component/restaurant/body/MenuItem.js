                                              ...
                                              <div className='pl-2'>
                                                ...
                                                <div className='min-w-[118px] h-[120px] font-light ml-4 mr-1 mt-1'>
                                                    <span className='relative flex justify-center' >
                                                      ...
                                                      :<div className=' w-24 h-9 text-[#60b246] flex justify-between items-center px-2 font-bold text-[.93rem] border-[1px] border-[#d4d9d5] pt-2 absolute  bottom-[-15px]  rounded-[4px] bg-white p'>
                                                      {console.log()}
