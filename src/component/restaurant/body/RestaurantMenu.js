...
export function RestaurantMenu(){
    ...
    useEffect(()=>{
      ...
      async  function getMenuList(){
        const data = await fetch(`https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=${lat}&lng=${lng}&restaurantId=${resId}&catalog_qa=undefined&submitAction=ENTER`)
                            ...
                            <div >
                                ...
                                <div className="flex justify-between  ">
                                    <div >
                                        ...
                                        {isRestInfo && isRestInfo?.cuisines.map((item)=>{
                                          return  <span className="text-[.73rem] turncate  text-[#7e808c]">{item},</span>
                                        })}
                                ...
                                <div>
                                    <div className="mt-3 flex items-center">
                                        ...
                                        <div className="flex  items-center">
                                            <span className="mr-2"><svg class="RestaurantTimeCost_icon__8UdT4" width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" fill="none"><circle r="8.35" transform="matrix(-1 0 0 1 9 9)" stroke="#3E4152" stroke-width="1.3"></circle><path d="M3 15.2569C4.58666 16.9484 6.81075 18 9.273 18C14.0928 18 18 13.9706 18 9C18 4.02944 14.0928 0 9.273 0C9.273 2.25 9.273 9 9.273 9C6.36399 12 5.63674 12.75 3 15.2569Z" fill="#3E4152"></path></svg></span>
                                ...
                                <div>
                                    <div className="mb-3 flex overflow-y-hidden overflow-x-scroll ">
                                        ...
                                        {
                                            isOffer && isOffer.map(item=>{
                                                {/* {console.log('coupon')}
                                                {console.log(item)} */}
                                                 return    <div className="mr-6 flex min-w-[200px]  rounded-lg pl-2 py-2 flex-col border-[1px] border-[#E0E0EB]">
